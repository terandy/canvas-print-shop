...
export const metadata: Metadata = {
  ...
  description:
    "Transform your photos into high-quality canvas prints. Expert hand-crafted in Quebec, Canada with premium materials and UVgel technology. Delivery to all ten Canadian provinces or free local pickup.",
  icons: {
    icon: [
