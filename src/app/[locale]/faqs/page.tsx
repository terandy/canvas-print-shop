...
export async function generateMetadata({
  ...
  return {
    ...
    ...canonicalMetadata(locale, "/faqs"),
    openGraph: {
      title: t("title"),
      description: t("description"),
      ...openGraphMetadata(locale, "/faqs"),
    },
  };
}
...
export default async function FAQ() {
  ...
  const faqItems = [
    {
      q: t("faq.questions.imageQuality.question"),
      a: t("faq.questions.imageQuality.answer"),
    },
    {
      q: t("faq.questions.depthDifference.question"),
      a: t("faq.questions.depthDifference.answer"),
    },
    {
      q: t("faq.questions.durability.question"),
      a: t("faq.questions.durability.answer"),
    },
    {
      q: t("faq.questions.multipleCanvases.question"),
      a: t("faq.questions.multipleCanvases.answer"),
    },
    {
      q: t("faq.questions.deliveryTime.question"),
      a: t("faq.questions.deliveryTime.answer"),
    },
    {
      q: t("faq.questions.localPickupAvailable.question"),
      a: t("faq.questions.localPickupAvailable.answer"),
    },
    {
      q: t("faq.questions.satisfaction.question"),
      a: t("faq.questions.satisfaction.answer"),
    },
  ];
