      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="text-center py-20 md:py-32">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-lg text-gray-500">
            Your photos deserve to be transformed into true works of art. Here
            is how we make that happen in our Quebec City workshop.
          </p>
        </header>
        ...
        <section className="text-center bg-white py-16 md:py-24 rounded-2xl shadow-xl mb-24">
          ...
          <p className="max-w-3xl mx-auto text-gray-600 mb-12">
            We believe in transparency. When you order from us, you are
            supporting a dedicated local team of craftspeople who care deeply
            about quality.
          </p>
